...
#             type_map = {"crawl": "crawl", "recon": "recon", "detect": "detect", "triage": "vuln", "report": "report", "error": "error"}
#             sub = ""
...
#     # ── Header row ────────────────────────────────────────────────────────────
#     col_hdr, col_status, col_btns = st.columns([4, 1, 2])
...
#         st.markdown(f"""
# <div style="background:{status_cfg[1]};border:1px solid {status_cfg[0]}44;border-radius:8px;
#             padding:8px 14px;text-align:center;font-size:12px;font-weight:700;
#             color:{status_cfg[0]};letter-spacing:.08em;margin-top:10px;">
#   {status_cfg[2]}
# </div>""", unsafe_allow_html=True)
...
#       🤖 TinyFish Agent · {current or 'browsing...'}
#     </span>
